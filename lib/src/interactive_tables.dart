...
class InteractiveTable extends StatefulWidget {
  ...
  /// },
  final Function(int row, int column, String newValue)? onTextEdit;
  ...
  ///  print('row: $row, column: $column, newValue: $newValue');
  ///  },
  final Function(int row, int column, String newValue)? onTextEditComplete;
  ...
  ///
  /// Example:
  /// onRowDeleteCallback: (List<int> rowIndexes) {
  ///   print('rows deleted: $rowIndexes');
  /// },
  final Function(List<int> rowIndexes)? onRowDeleteCallback;
          ...
          : Padding(
              ...
              child: FormBuilderTextField(
                  ...
                  onChanged: (String? value) {
                    ...
                    if (widget.onTextEdit != null) {
                      widget.onTextEdit!(index, widget.cols.indexOf(col), value!);
                    }
                  },
                  onEditingComplete: () {
                    widget.formKey.currentState!.save();
                    if (widget.onTextEditComplete != null) {
                      widget.onTextEditComplete!(index, widget.cols.indexOf(col), widget.formKey.currentState!.value[getFormFieldName(index, widget.cols.indexOf(col))]);
                    }
                  },
                ),
              ),
                ...
                onPressed: () {
                  setState(() {
                   if (widget.onRowDeleteCallback != null) {
                    ...
                    _dataList.removeWhere((element) => isInSelectedList(element));
                    _filteredDataList.removeWhere((element) => isInSelectedList(element));
                    _selectedDataList.clear();
                  });
                },
              )
